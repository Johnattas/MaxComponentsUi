<template>
    <InputBase v-bind="props" class="max-input-credit-card input-credit-card-number-base" text-center :label="props.label" :done="done" :required="props.required" :error="error_msg">
